# current issue in the bible_vul_toclean.py:
#
# {
#   "Gen": {
#     "title": "Genesis",
...
# problem is the large spaces between "Psalmus ipsi David." and "Misericordiam..."
# these should be removed.
# all spaces larger than 1 should be replaced with a single space.
...
if __name__ == '__main__':
    ...
    input_file = data_dir / 'bible_vul_toclean.json'
    output_file = data_dir / 'bible_vul_clean.json'
